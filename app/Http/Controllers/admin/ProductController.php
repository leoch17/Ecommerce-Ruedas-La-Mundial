...
class ProductController extends Controller
{
    ...
    public function index(Request $request) {
        $products = Product::latest('id')->with('products_images');
    ...
    public function edit($id, Request $request) {
        ...
        if ($product->related_products != '') {
            ...
            $relatedProducts = Product::whereIn('id',$productArray)->with('products_images')->get();
        }
    ...
    public function destroy($id, Request $request) {
        ...
        if (empty($product)) {
            $request->session()->flash('error','Producto no encontrado');
            return response()->json([
                'status' => false,
                'notFound' => true
            ]);
    ...
    public function changeRatingStatus(Request $request) {
        ...
        session()->flash('success','Estado cambiado satisfactoriamente');
