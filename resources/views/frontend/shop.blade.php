                                                    ...
                                                    <div class="accordion-body">
                                                        <div class="navbar-nav">
                                                            @foreach ($category->sub_category as $subCategory)
                                                                <a href="{{ route('frontend.shop', [$category->slug, $subCategory->slug]) }}"
                            ...
                            <div class="d-flex align-items-center justify-content-end mb-4">
                                <div class="ml-2">
                                    <select name="sort" id="sort" class="form-control">
                                        <option value="latest" {{ $sort == 'latest' ? 'selected' : '' }}>Último</option>
                                        <option value="price_desc" {{ $sort == 'price_desc' ? 'selected' : '' }}>Precio
                                            Alto</option>
                                        <option value="price_asc" {{ $sort == 'price_asc' ? 'selected' : '' }}>Precio Bajo
                                        </option>
                                    </select>
                                </div>
                            </div>
