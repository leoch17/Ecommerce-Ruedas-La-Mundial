                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                        <form class="shake" role="form" method="post" id="contactForm" name="contactForm">
                            <div class="mb-3">
                                <label class="mb-2" for="name">Nombre Completo</label>
                            ...
                            <div class="form-submit">
                                <button class="btn btn-dark" type="submit" id="form-submit"><i
                                        class="material-icons mdi mdi-message-outline"></i> Enviar Mensaje</button>
            ...
            $.ajax({
                ...
                success: function(response) {
                    ...
                    if (response.status == true) {
                        window.location.href = '{{ route('frontend.page', $page->slug) }}';
                    } else {
