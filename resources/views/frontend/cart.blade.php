        ...
        <div class="container">
            <div class="light-font">
                <ol class="breadcrumb primary-color mb-0">
                    <li class="breadcrumb-item"><a class="white-text" href="{{ route('frontend.home') }}">Inico</a></li>
                ...
                @if (Cart::count() > 0)
                    ...
                    <div class="col-md-4">
                        <div class="card cart-summery">
                            <div class="sub-title">
                                <h2 class="bg-white">Resumen del carrito</h3>
                            </div>
                            <div class="card-body">
                                ...
                                <div class="pt-5">
                                    <a href="{{ route('frontend.checkout') }}"
                                        class="btn-dark btn btn-block w-100">Proceder a la compra</a>
                                </div>
                            </div>
                        </div>
...
@section('customJs')
    <script>
        ...
        function deleteItem(rowId) {
            if (confirm("¿Estas seguro que quieres eliminar este producto del carrito?")) {
                $.ajax({
