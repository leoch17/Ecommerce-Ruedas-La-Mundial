        ...
        <div class="container">
            <div class="light-font">
                <ol class="breadcrumb primary-color mb-0">
                    <li class="breadcrumb-item"><a class="white-text" href="{{ route('account.profile') }}">Mi Cuenta</a></li>
                    <li class="breadcrumb-item">Mi Lista de Deseos</li>
                </ol>
            </div>
        </div>
    </section>
                ...
                <div class="col-md-9">
                    <div class="card">
                        <div class="card-header">
                            <h2 class="h5 mb-0 pt-2 pb-2">Mi Lista de Deseos</h2>
                        </div>
                        <div class="card-body p-4">
                                    ...
                                    <div class="d-sm-flex justify-content-between mt-lg-4 mb-4 pb-3 pb-sm-2 border-bottom">
                                        <div class="d-block d-sm-flex align-items-start text-center text-sm-start">
                                            ...
                                            <a class="d-block flex-shrink-0 mx-auto me-sm-4"
                                                href="{{ route('frontend.product', $wishlist->product->slug) }}"
                                                style="width: 10rem;">
                                            ...
                                            <div class="pt-2">
                                                <h3 class="product-title fs-base mb-2">
                                                    <a href="{{ route('frontend.product', $wishlist->product->slug) }}">{{ $wishlist->product->title }}
                                                    </a>
                                                </h3>
                            ...
                            @else
                                <div>
                                    <h3 class="h5">¡¡Tu lista de deseos esta vacia!!</h3>
                                </div>
                            @endif
                        </div>
                    </div>
