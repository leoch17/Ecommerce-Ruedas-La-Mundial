                                    ...
                                    <div class="col-md-12">
                                        <div class="mb-3">
                                            ...
                                            <input type="text" readonly name="slug" id="slug"
                                                class="form-control" placeholder="Etiqueta" value="{{ $product->slug }}">
                                            <p class="error"></p>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-6">
                                        <div class="mb-3">
                                            ...
                                            <input type="text" name="sku" id="sku" class="form-control"
                                                placeholder="ume" value="{{ $product->sku }}">
                                            <p class="error"></p>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                    ...
                                    <div class="col-md-12">
                                        ...
                                        <div class="mb-3">
                                            <input type="number" min="0" name="qty" id="qty"
                                                class="form-control" placeholder="Cantidad" value="{{ $product->qty }}">
                                            <p class="error"></p>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="card-body">
                                ...
                                <div class="mb-3">
                                    <select name="status" id="status" class="form-control">
                                        <option {{ $product->status == 1 ? 'selected' : '' }} value="1">Activo
                                        </option>
                                        <option {{ $product->status == 0 ? 'selected' : '' }} value="0">Inactivo
                                        </option>
                                    </select>
                                </div>
                            </div>
                            ...
                            <div class="card-body">
                                ...
                                <div class="mb-3">
                                    <select name="is_featured" id="is_featured" class="form-control">
                                        ...
                                        <option {{ $product->is_featured == 'Yes' ? 'selected' : '' }} value="Yes">Si
                                        </option>
                                    </select>
                                    <p class="error"></p>
                                </div>
