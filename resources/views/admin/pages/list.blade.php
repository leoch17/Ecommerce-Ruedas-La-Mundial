        ...
        <div class="container-fluid my-2">
            <div class="row mb-2">
                ...
                <div class="col-sm-6 text-right">
                    <a href="{{ route('pages.create') }}" class="btn btn-primary">Nueva Página Estática</a>
                </div>
            </div>
        </div>
        <!-- /.container-fluid -->
                ...
                <div class="card-body table-responsive p-0">
                    <table class="table table-hover text-nowrap">
                        ...
                        <tbody>
                            ...
                            @else
                                <tr>
                                    <td colspan="5">Páginas no encontradas</td>
                                </tr>
                            @endif
                        </tbody>
                    </table>
...
@section('customJs')
    <script>
        function deletePage(id) {
            ...
            if (confirm("¿Esta seguro que quiere eliminar esta página?")) {
                $.ajax({
                    url: newUrl,
                    type: 'delete',
                    data: {},
