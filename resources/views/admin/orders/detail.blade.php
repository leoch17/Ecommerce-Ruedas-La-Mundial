                        ...
                        <div class="card-header pt-3">
                            <div class="row invoice-info">
                                <div class="col-sm-4 invoice-col">
                                    <h1 class="h5 mb-3">Dirección de Envío</h1>
                                    <address>
                                        <strong>{{ $order->first_name . ' ' . $order->last_name }}</strong><br>
                                        {{ $order->address }}<br>
                                        {{ $order->city }}, {{ $order->zip }} {{ $order->stateName }}<br>
                                        Teléfono: {{ $order->mobile }}<br>
                        ...
                        <div class="card-body table-responsive p-3">
                            <table class="table table-striped">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        <th colspan="3" class="text-right">Descuento:
                ...
                <div class="col-md-3">
                    <div class="card">
                        <form action="" method="post" name="changeOrderStatusForm" id="changeOrderStatusForm">
                            <div class="card-body">
                                <h2 class="h4 mb-3">Estado de Pedido</h2>
                                <div class="mb-3">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input placeholder="dd-MM-YYYY" value="{{ $order->shipped_date }}" type="datetime"
                    ...
                    <div class="card">
                        <div class="card-body">
                            <form action="" method="post" name="sendInvoiceEmail" id="sendInvoiceEmail">
                                <h2 class="h4 mb-3">Enviar Factura por Correo Electrónico</h2>
                                <div class="mb-3">
...
@section('customJs')
    <script>
        ...
        $("#changeOrderStatusForm").submit(function(event) {
            ...
            if (confirm("¿Estas seguro que quieres cambiar de estado de pedido?")) {
        ...
        $("#sendInvoiceEmail").submit(function(event) {
            ...
            if (confirm("¿Estas seguro que quieres enviar un correo electrónico?")) {
                $.ajax({
