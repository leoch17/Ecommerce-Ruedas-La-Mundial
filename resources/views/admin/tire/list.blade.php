        ...
        <div class="container-fluid my-2">
            <div class="row mb-2">
                ...
                <div class="col-sm-6 text-right">
                    <a href="{{ route('tires.create') }}" class="btn btn-primary">Nuevo Neumático</a>
                </div>
            </div>
        </div>
        <!-- /.container-fluid -->
                ...
                <form action="" method="get">
                    <div class="card-header">
                        <div class="card-title">
                            <button type="button" onclick="window.location.href='{{ route('tires.index') }}'"
                            ...
                            @if ($tires->isNotEmpty())
                                @foreach ($tires as $tire)
                                    <tr>
                                        <td>{{ $tire->id }}</td>
                                        <td>{{ $tire->name }}</td>
                                        <td>{{ $tire->vehicleName }}</td>
                                        <td>{{ $tire->suspensionName }}</td>
                                        <td>{{ $tire->slug }}</td>
                                        <td>
                                            @if ($tire->status == 1)
                                        ...
                                        <td>
                                            ...
                                            <a href="#" onclick="deleteTire({{ $tire->id }})"
