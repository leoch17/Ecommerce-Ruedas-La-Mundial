...
@section('content')
    ...
    <section class="content-header">
        <div class="container-fluid my-2">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1>Cupones con Descuento</h1>
                </div>
                <div class="col-sm-6 text-right">
                    <a href="{{ route('coupons.create') }}" class="btn btn-primary">Nuevo Cupón de Descuento</a>
                </div>
            </div>
        </div>
        <!-- /.container-fluid -->
...
@section('customJs')
    <script>
        function deleteCoupon(id) {
            ...
            if (confirm("¿Esta seguro que quiere eliminar este cupón?")) {
                $.ajax({
                    url: newUrl,
                    type: 'delete',
                    data: {},
