        ...
        <div class="container-fluid my-2">
            <div class="row mb-2">
                ...
                <div class="col-sm-6 text-right">
                    <a href="{{ route('suspensions.create') }}" class="btn btn-primary">Nueva Suspensión</a>
                </div>
            </div>
        </div>
        <!-- /.container-fluid -->
                ...
                <form action="" method="get">
                    <div class="card-header">
                        <div class="card-title">
                            <button type="button" onclick="window.location.href='{{ route('suspensions.index') }}'"
                ...
                <div class="card-body table-responsive p-0">
                    <table class="table table-hover text-nowrap">
                        ...
                        <tbody>
                            @if ($suspensions->isNotEmpty())
                                @foreach ($suspensions as $suspension)
                                    <tr>
                                        ...
                                        <td>{{ $suspension->vehicleName }}</td>
                                        <td>{{ $suspension->slug }}</td>
                                        <td>
                                            @if ($suspension->status == 1)
                                        ...
                                        <td>
                                            ...
                                            <a href="#" onclick="deleteSuspension({{ $suspension->id }})"
                            ...
                            @else
                                <tr>
                                    <td colspan="5">Elemento no encontrado</td>
                                </tr>
                            @endif
                        </tbody>
                    </table>
...
@section('customJs')
    <script>
        function deleteSuspension(id) {
            var url = '{{ route('suspensions.delete', 'ID') }}';
